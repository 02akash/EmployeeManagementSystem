...
namespace EmployeeManagementSystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\lucky\Source\Repos\Employee-Management-System-in-CSharp\EmployeeManagementSystem\EmployeeManagementSystem\employee.mdf;Integrated Security=True;Connect Timeout=30");
                    ...
                    try
                    {
                        ...
                        using(SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\lucky\Source\Repos\Employee-Management-System-in-CSharp\EmployeeManagementSystem\EmployeeManagementSystem\Directory\"
